      ...
      <div className="description-container">
        ...
        <div className="second-section">
          <p className="desc-content">
            ...
            appassiona e mi diverte. Ho una solida base in HTML, CSS e
            JavaScript e React. Il mio viaggio è iniziato da poco e non ho
            intenzione di fermarmi allo sviluppo frontend.
          </p>
